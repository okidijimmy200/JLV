  ...
  return (
    <>
                ...
                <ul className='nav__bar__list'>
                        ...
                        <li className="nav__bar__item"><HashLink smooth to='/#contact'  className='nav__bar__hash' style={style} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>Services</HashLink></li>
