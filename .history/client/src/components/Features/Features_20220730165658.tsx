                ...
                <div className="row">
                    ...
                    <div className="col-1-of-2 ">
                        <div className="composition">
                            <img src="../../../images/farm.jpg" alt="photo 1" className="composition__photo composition__photo--p1"/>
                            <img src="../../../images/farm.jpg" alt="photo 2" className="composition__photo composition__photo--p2"/>
                            <img src="../../../images/farm.jpgimages/laptop2.jpg" alt="photo 3" className="composition__photo composition__photo--p3"/>
                        </div>
                    </div>
                </div>
            </section>
