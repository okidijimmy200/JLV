...
import { NavLink, L } from 'react-router-dom'
...
export default function Nav() {
  ...
  return (
    <>
                ...
                <div className='header__logo'><Link to='/'></Link>
                ...
                <ul className='nav__bar__list'>
                        ...
                        <li className="nav__bar__item"><HashLink smooth to='/#section1'  className='nav__bar__hash' style={style} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>Services</HashLink></li>
