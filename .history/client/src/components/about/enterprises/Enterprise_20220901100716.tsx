      ...
      <div>
        <div className='row'>
          <div className='col-1-of-3'>
            <div className={classes.root}>
              ...
              <div className={classes.textarea}>
                ...
                <h4 className={classes.detail}>Uganda</h4>
              </div>
          ...
          <div className={classes.root}>
              ...
              <div className={classes.textarea}>
                <h3 className={classes.title}>JLV Diary</h3>
                <h4 className={classes.detail}>Uganda, Kenya, Tanzania</h4>
              </div>
          ...
          <div className={classes.root}>
              ...
              <div className={classes.textarea}>
                <h3 className={classes.title}>JLV Resort</h3>
                <h4 className={classes.detail}>Uganda</h4>
              </div>
